    ...
    function showAll(){
	  ...
	  $.getJSON("https://"+cartoDBUserName+".cartodb.com/api/v2/sql?format=GeoJSON&q="+sqlQuery3, function(data) {
        road = L.geoJson(data,{
          onEachFeature: function (feature, layer) {
            layer.bindPopup('<p>' + feature.properties.name + '</p><p> From ' + feature.properties._from + ' To ' + feature.properties._to + '<br><a href="https://www.google.com/maps/dir/' + feature.properties.from_where + '/' + feature.properties.from_where + '" target="_blank">Get direction</a></p>', customOptions);
      ...
      $.getJSON("https://"+cartoDBUserName+".cartodb.com/api/v2/sql?format=GeoJSON&q="+sqlQuery, function(data) {
        sites = L.geoJson(data,{
          onEachFeature: function (feature, layer) {
            var popupContent2 = '<h2><b>' + feature.properties.sites + '</h2><p>' + feature.properties.description + '<br>' + '<a href="' + feature.properties.website + '" target="_blank">Website</a></p><img src="' +  feature.properties.picture_filename + '"' + 'style="width:180px;">';
			layer.bindPopup(popupContent2, customOptions);
            layer.cartodb_id=feature.properties.cartodb_id;
          },
	  ...
	  $.getJSON("https://"+cartoDBUserName+".cartodb.com/api/v2/sql?format=GeoJSON&q="+sqlQuery2, function(data) {
        POI = L.geoJson(data,{
          onEachFeature: function (feature, layer) {
            layer.bindPopup('<p>' + feature.properties.poi + ' (' + feature.properties.description + ')</p><img src="' +  feature.properties.picture_filename + '"' + 'style="width:100px;">', customOptions);
            layer.cartodb_id=feature.properties.cartodb_id;
          },
		  pointToLayer: function (feature, latlng) {
    ...
    var cartoDBUserName = "heshemap";
	  ...
	  $.getJSON("https://"+cartoDBUserName+".cartodb.com/api/v2/sql?format=GeoJSON&q="+route, function(data) {
        routes = L.geoJson(data,{
          onEachFeature: function (feature, layer) {
            layer.bindPopup('<p>' + feature.properties.name + '</p><p> From ' + feature.properties._from + 'To ' + feature.properties._to + '<br><a href="https://www.google.com/maps/dir/' + feature.properties.from_where + '/' + feature.properties.to_where + '" target="_blank">Get direction</a></p>', customOptions);
            layer.cartodb_id=feature.properties.cartodb_id;
          },
